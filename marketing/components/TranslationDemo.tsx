...
export function TranslationDemo() {
  ...
  const [translationHistory, setTranslationHistory] = useState<
    Array<{ english: string; spanish: string; id: number }>
  >([]);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setTranslationHistory((prev) => [
        ...prev,
        { ...phrases[currentIndex], id: nextId.current++ },
      ]);
    }, 1500);
      ...
      <CardHeader className="flex flex-row items-center justify-between border-b border-primary/10">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <Badge
              variant="secondary"
              className="mt-1 bg-primary/20 text-primary hover:bg-primary/30 ring-1 ring-primary/20"
            >
              Active Speaker
            </Badge>
          </div>
            ...
            {translationHistory.map((phrase) => (
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 text-right italic text-primary font-medium">
                    {phrase.spanish}
                  </div>
                </div>
